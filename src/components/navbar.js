...
<div
  ...
  className="fixed top-0 left-0 h-1 bg-[#FE3033] transition-all duration-200"
></div>

{/* Navbar Section */}
<nav id="navbar" className="fixed top-0 left-0 w-full bg-white text-black py-3 px-8 flex justify-between shadow-md items-center z-40">
...
>>>>>>> 24b1d2d8c5314d2ac642571213977f50fa2a33da
        </div>
      </div>
    </div>
    <div className="relative group">
