...
const ContactForm = () => {
  ...
  return (
    <div className="bg-white text-white py-16 px-6 flex justify-between items-start w-full">
      {/* Got a project Section */}
      <div className="bg-[#ff3131] rounded-lg p-10 text-left flex-1 mr-4">
        ...
        <button className="mt-6 bg-black text-white px-4 py-2 rounded">Listen Now</button>
      </div>

      {/* Contact Form Section */}
      <form onSubmit={handleSubmit} className="bg-gray-800 p-10 rounded-lg flex-1 w-full max-w-md">
